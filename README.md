...
* [GitHub - typora/wiki-website: Support site for Markdown Editor Typora](https://github.com/typora/wiki-website)
...
See [Google Documentation Guide](https://github.com/google/styleguide/tree/gh-pages/docguide) .

* [Google Markdown Style Guide](Markdown_Style_Guide.md)
